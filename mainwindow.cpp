...
{ wxWindow  *parent = NULL;
	...
	txon->Disable();
	txtimeout = new wxChoice(this, ID_CHOICE1, wxPoint(840,408), wxSize(56,32), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE1"));
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("TX timeout in min."), wxPoint(720,416), wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	wantedloc = new wxTextCtrl(this, ID_TEXTCTRL10, wxEmptyString, wxPoint(608,72), wxSize(80,330), wxTE_MULTILINE, wxDefaultValidator, _T("ID_TEXTCTRL10"));
	ignorelist = new wxTextCtrl(this, ID_TEXTCTRL8, wxEmptyString, wxPoint(504,72), wxSize(100,330), wxTE_MULTILINE, wxDefaultValidator, _T("ID_TEXTCTRL8"));
	wantedlist = new wxTextCtrl(this, ID_TEXTCTRL7, wxEmptyString, wxPoint(400,72), wxSize(100,330), wxTE_MULTILINE, wxDefaultValidator, _T("ID_TEXTCTRL7"));
	usewantedlist = new wxRadioButton(this, ID_RADIOBUTTON1, _("Use wanted list"), wxPoint(688,304), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
	useignorelist = new wxRadioButton(this, ID_RADIOBUTTON2, _("Use ignore list"), wxPoint(688,328), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
	usemindistance = new wxRadioButton(this, ID_RADIOBUTTON3, _("Min. distance km. :"), wxPoint(688,376), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON3"));
	mindistance = new wxTextCtrl(this, ID_TEXTCTRL9, _("3000"), wxPoint(840,376), wxSize(97,24), 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
	StaticText6 = new wxStaticText(this, ID_STATICTEXT6, _("Wanted DX"), wxPoint(416,48), wxSize(72,19), 0, _T("ID_STATICTEXT6"));
	...
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("Ignored DX"), wxPoint(520,48), wxSize(72,19), 0, _T("ID_STATICTEXT7"));
	...
	usecq = new wxRadioButton(this, ID_RADIOBUTTON4, _("All CQ\'s"), wxPoint(688,280), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON4"));
	usecq->SetValue(true);
	StaticText8 = new wxStaticText(this, ID_STATICTEXT8, _("Wanted LOC"), wxPoint(616,48), wxSize(72,19), 0, _T("ID_STATICTEXT8"));
	...
	usewantedloc = new wxRadioButton(this, ID_RADIOBUTTON6, _("Use wanted LOC"), wxPoint(688,352), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON6"));
	...
	Button4 = new wxButton(this, ID_BUTTON7, _("Load"), wxPoint(400,408), wxSize(100,33), 0, wxDefaultValidator, _T("ID_BUTTON7"));
	Button5 = new wxButton(this, ID_BUTTON8, _("Load"), wxPoint(608,408), wxSize(80,33), 0, wxDefaultValidator, _T("ID_BUTTON8"));
	Button3 = new wxButton(this, ID_BUTTON6, _("Load"), wxPoint(504,408), wxSize(100,33), 0, wxDefaultValidator, _T("ID_BUTTON6"));
